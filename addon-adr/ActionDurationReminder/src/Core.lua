...
addon.registerDebugSubSwitch(DSS_ACTION_FIND, 'debugActionFind', 'Action Find [AF*]', 'Log action finding operations')
addon.registerDebugSubSwitch(DSS_ACTION_NEW, 'debugActionNew', 'Action New [AN*]', 'Log action creation')
addon.registerDebugSubSwitch(DSS_ACTION_MATCH, 'debugActionMatch', 'Action Match [AM*]', 'Log action matching operations')
addon.registerDebugSubSwitch(DSS_ACTION_UNREF, 'debugActionUnref', 'Action Unref [AU]', 'Log unref operations')
addon.registerDebugSubSwitch(DSS_ACTION_STACK, 'debugActionStack', 'Action Stack [AK*]', 'Log stack count updates')
addon.registerDebugSubSwitch(DSS_ACTION_REMOVE, 'debugActionRemove', 'Action Remove [AR*]', 'Log action removals')
addon.registerDebugSubSwitch(DSS_ACTION_DELETE, 'debugActionDelete', 'Action Delete [AD*]', 'Log action deletions from maps')
addon.registerDebugSubSwitch(DSS_ACTION_SAVE, 'debugActionSave', 'Action Save [AS]', 'Log when actions are saved')
addon.registerDebugSubSwitch(DSS_ACTION_CLEAR, 'debugActionClear', 'Action Clear [AC*]', 'Log action clearing')

addon.registerDebugSwitch(DS_EFFECT, "Effect Debug")
addon.registerDebugSubSwitch(DSS_EFFECT_GAIN, 'debugEffectGain', 'Effect Gain [E+]', 'Log effect gained events')
addon.registerDebugSubSwitch(DSS_EFFECT_FADE, 'debugEffectFade', 'Effect Fade [E-]', 'Log effect faded events')
addon.registerDebugSubSwitch(DSS_EFFECT_UPDATE, 'debugEffectUpdate', 'Effect Update [E=]', 'Log effect updated events')
addon.registerDebugSubSwitch(DSS_EFFECT_REFRESH, 'debugEffectRefresh', 'Effect Refresh [E*]', 'Log effect refresh events')
addon.registerDebugSubSwitch(DSS_EFFECT_TRANSFER, 'debugEffectTransfer')
addon.registerDebugSubSwitch(DSS_EFFECT_MISS, 'debugEffectMiss')

addon.registerDebugSwitch(DS_COMBAT, "Combat Debug")
addon.registerDebugSubSwitch(DSS_COMBAT_EVENT, 'debugCombatEvent', 'Combat Event [CE]', 'Log combat events')
addon.registerDebugSubSwitch(DSS_COMBAT_FADE, 'debugCombatFade', 'Combat Fade [C-]', 'Log combat fade/cancel')
addon.registerDebugSubSwitch(DSS_COMBAT_STACK, 'debugCombatStack', 'Combat Stack [CS-]', 'Log combat stack consumption')
addon.registerDebugSubSwitch(DSS_COMBAT_TICK, 'debugCombatTick', 'Combat Tick [CT]', 'Log tick effects')
addon.registerDebugSubSwitch(DSS_COMBAT_DURATION, 'debugCombatDuration', 'Combat Duration [CD]', 'Log duration gained')
addon.registerDebugSubSwitch(DSS_COMBAT_CHANNEL, 'debugCombatChannel', 'Combat Channel [CC]', 'Log channel duration')

addon.registerDebugSwitch(DS_FILTER, "Filter Debug")
addon.registerDebugSubSwitch(DSS_FILTER_ACCEPT, 'debugFilterAccept', 'Filter Accept [FA*]', 'Log accepted effects/actions')
addon.registerDebugSubSwitch(DSS_FILTER_REJECT, 'debugFilterReject', 'Filter Reject [FR*]', 'Log rejected effects/actions')

addon.registerDebugSwitch(DS_TARGET, "Target Debug")
addon.registerDebugSubSwitch(DSS_TARGET_TRACK, 'debugTargetTrack', 'Target Track', 'Log target tracking changes')
